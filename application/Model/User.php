...
class User extends Model
{
    ...
    {
        $sql = "SELECT idUsuario, usuario, nombreCompleto, correoElectronico, estado, rol, codigo, fechaRecuperacion FROM tblUsuario ORDER BY idUsuario DESC";
    ...
    /**
     * Obtener todos los usuarios de la base de datos sin incluir el actual
     */
    public function getAllUsersWithoutCurrent($p_idUsuario)
    {
        $sql = "SELECT idUsuario, usuario, nombreCompleto, correoElectronico, estado, rol, codigo, fechaRecuperacion FROM tblUsuario WHERE idUsuario != :p_idUsuario ORDER BY idUsuario DESC";
    ...
    public function getAllUsersByStatus($p_estado)
    {
        ...
        $sql = "SELECT idUsuario, usuario, nombreCompleto, correoElectronico, estado, rol, codigo, fechaRecuperacion FROM tblUsuario WHERE estado = :p_estado ORDER BY idUsuario DESC";
     ...
     * @param string $p_rol Rol que tiene el usuario dentro de la aplicacion
     * 
     */
    public function addUser($p_usuario, $p_contrasena, $p_nombreCompleto, $p_correoElectronico, $p_rol)
    {
        $sql = "INSERT INTO tblUsuario(usuario, contrasena, nombreCompleto, correoElectronico, rol) VALUES(:p_usuario, :p_contrasena, :p_nombreCompleto, :p_correoElectronico, :p_rol)";
        $parameters = array(
            ':p_usuario' => $p_usuario,
    ...
    {
        $sql = "SELECT idUsuario, usuario, nombreCompleto, correoElectronico, estado, rol, codigo, fechaRecuperacion FROM tblUsuario WHERE idUsuario = :p_idUsuario LIMIT 1";
        $parameters = array(':p_idUsuario' => $p_idUsuario);
     ...
     * 
     */
    public function updateUser($p_usuario, $p_nombreCompleto, $p_correoElectronico, $p_rol, $p_idUsuario)
    {
        $sql = "UPDATE tblUsuario SET usuario = :p_usuario, nombreCompleto = :p_nombreCompleto, correoElectronico = :p_correoElectronico, rol = :p_rol WHERE idUsuario = :p_idUsuario";
        $parameters = array(
            ':p_usuario' => $p_usuario,
            ':p_nombreCompleto' => $p_nombreCompleto,
            ':p_correoElectronico' => $p_correoElectronico,
    ...
    {
        $sql = "SELECT idUsuario, usuario, contrasena, nombreCompleto, correoElectronico, estado, rol, codigo, fechaRecuperacion FROM tblUsuario WHERE usuario = :p_usuario AND estado = 1 LIMIT 1";
    ...
    /**
     * Obtener una persona con su usuario para validar si ya existe
     * @param string $p_correoElectronico
     */
    public function validateUser($p_usuario)
    {
    ...
    /**
     * Obtener una persona con su usuario y donde el id sea diferente al de el 
     * @param string $p_correoElectronico
     * @param int $p_idUsuario Id del usuario a buscar 
     */
    public function validateUserUpdate($p_usuario, $p_idUsuario)
    {
        $sql = "SELECT idUsuario, usuario, contrasena, nombreCompleto, correoElectronico, estado, rol, codigo, fechaRecuperacion FROM tblUsuario WHERE usuario = :p_usuario AND idUsuario != :p_idUsuario LIMIT 1";
        $parameters = array(
            ':p_usuario' => $p_usuario,
            ':p_idUsuario' => $p_idUsuario
        );
    ...
    {
        $sql = "SELECT idUsuario, usuario, contrasena, nombreCompleto, correoElectronico, estado, rol, codigo, fechaRecuperacion FROM tblUsuario WHERE correoElectronico = :p_correoElectronico AND estado = 1 LIMIT 1";
    ...
    /**
     * Obtener una persona con su correo electrónico para validar si ya existe
     * @param string $p_correoElectronico
     */
    ...
    /**
     * Obtener una persona con su correo electrónico y donde el id sea diferente al de el 
     * @param string $p_correoElectronico
     * @param int $p_idUsuario Id del usuario a buscar
     */
    public function validateEmailUpdate($p_correoElectronico, $p_idUsuario)
    {
        $sql = "SELECT idUsuario, usuario, contrasena, nombreCompleto, correoElectronico, estado, rol, codigo, fechaRecuperacion FROM tblUsuario WHERE correoElectronico = :p_correoElectronico AND idUsuario != :p_idUsuario LIMIT 1";
        $parameters = array(
            ':p_correoElectronico' => $p_correoElectronico,
            ':p_idUsuario' => $p_idUsuario
        );
    ...
    {
        $sql = "SELECT idUsuario, usuario, contrasena, nombreCompleto, correoElectronico, estado, rol, codigo, fechaRecuperacion FROM tblUsuario WHERE codigo = :p_codigo AND estado = 1 LIMIT 1";
