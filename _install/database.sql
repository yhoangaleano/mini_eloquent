...
-- Tiempo de generación: 11-12-2018 a las 17:19:30
...
(5, 'Variedades y Comunicaciones', 'Régimen Simplificado', '98763007-1', 'uploads/factory/1540222447_Jobs-y-Wozniak-en-el-garaje.jpg', 'Cra. 36 A No. 77 BB - 45 Robledo Bello Horizonte', '4746745', '3005659290', 'variedcom@gmail.com', 'Venta y Servicio Técnico de Celulares. Internet - Papelería - Llamadas a Celular. Reparación y Accesorios para Computadores.', 'LA GARANTÍA NO CUBRE. Golpes, humedad, sobrecarga, equipos apagados, pantalla táctil, flex, yustin y levantamiento de sellos de garantía. NO SE DEVUELVE DINERO. No nos hacemos Responsables por teléfonos o accesorios que no sean reclamados después de 30 días. Se presume que los equipos traídos son de buena procedencia.');
...
(5, 'No existe el servicio con el ID 1', 'Service', '42S22', 'SQLSTATE[42S22]: Column not found: 1054 Unknown column \'id\' in \'where clause\' (SQL: update `tblServicio` set `tblServicio`.`updated_at` = 2018-10-22 13:01:01, `nombreServicio` = Servicio Técnico hhhh, `updated_at` = 2018-10-22 13:01:01 where `id` is null)', '2018-10-22 18:01:01'),
...
(1, 'Servicio Técnico', 1, '2018-10-22 17:40:50', '2018-10-22 17:40:50', NULL),
(2, 'Software', 1, '2018-10-22 17:41:00', '2018-10-22 17:41:00', NULL),
(3, 'Asesorías', 1, '2018-10-22 17:50:21', '2018-10-22 19:25:35', NULL);
...
(41, 'jesusmunoz', '$2y$10$jat1oXB9lL2ZVB1GKvYdcOwAy1myw1mGmi2HMOxnrouIgpMdIY7QC', 'Jesus Antonio Muñoz Gonzalez', 'sguarin025@misena.edu.co', 1, 'ADMINISTRADOR', '1537402462JfBDJQPC', '2018-09-21 00:14:22');
