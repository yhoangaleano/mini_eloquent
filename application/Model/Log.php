...
class Log extends Model
{
    ...
    public function getAllLogs()
    {
        try{
            ...
            $sql = "SELECT idLog, query_error, modelo, codigoError, mensajeError, fecha FROM tblLog";
    ...
    public function addLog($p_sql, $p_modelo, $p_codigoError, $p_mensajeError)
    {
        ...
        try {
            ...
            $sql = "INSERT INTO tblLog(query_error, modelo, codigoError, mensajeError) VALUES (:p_sql, :p_modelo, :p_codigoError, :p_mensajeError)";
    ...
    public function getLog($p_idLog)
    {
        ...
        try {
            ...
            $sql = "SELECT idLog, query_error, modelo, codigoError, mensajeError, fecha FROM tblLog WHERE idLog = :p_idLog LIMIT 1";
            $query = $this->db->prepare($sql);
