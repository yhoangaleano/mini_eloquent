...
<body>
    ...
    <div class="wrapper">
        <div id="formContent">
            ...
            <form id="formNewPassword">
                ...
                <input type="hidden" id="txtCode" name="txtCode" placeholder="Código de recuperación" value="<?php echo $code; ?>">
    ...
    <script src="<?php echo URL; ?>js/pages/newPassword.js"></script>
